...
const Login = () => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            // [ELIMINADO] Verificación de email ya no es requerida
            // if (!user.emailVerified) { ... }

            // Verificamos el rol en Firestore para redirigir correctamente
            ...
            if (userDoc.exists()) {
                ...
                // Si por alguna razón no existe el doc (caso raro), mandamos a user
                navigate('/dashboard/user');
            }
